...
def LVPassiveFilling_tiso_orig(geoparams, hoparams, sampleid=0):
#(mesh, base, endo, epi, ds, n_mesh, f_0, s_0, n_0, 
#								sampleid, a, b, a_f, b_f):
	"""
	sampleid: sample id
	a, b, a_f, b_f: Holzapfel-Ogden parameters
	"""
	print("TISO________________",hoparams)
	...
	outdef_avg = np.mean(outdef, axis=1)
